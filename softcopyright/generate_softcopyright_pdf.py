...
OUTPUT = ROOT / 'softcopyright' / '软著源程序-别捞水果-V1.0.0.pdf'

# ★ 软件全称+版本号必须与申请表保持一致；如申请表名称调整，只改这里即可。
...
def select_lines(all_lines):
    """不足 60 页全部提交；超过 60 页取前 30 页 + 后 30 页。"""
