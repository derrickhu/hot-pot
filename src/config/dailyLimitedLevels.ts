...
export const DAILY_LIMITED_LEVELS: readonly DailyThemeLevelDef[] = [
  ...
  },
  {
    ...
    themeName: '今日主题：多肉桃桃',
    drinkName: '多肉桃桃',
    targets: [{ fruitId: 'peach', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
  ...
  },
  {
    ...
    drinkName: '百香果爆柠檬',
    targets: [
      { fruitId: 'passionfruit', requiredCount: 12, cardCopies: 14 },
      { fruitId: 'lemon', requiredCount: 3, cardCopies: 5 },
    ],
  ...
  },
  {
    ...
    drinkName: '青提茉莉茶',
    targets: [{ fruitId: 'grape_green', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '西柚茉莉茶',
    targets: [{ fruitId: 'grapefruit', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '草莓乌龙茶',
    targets: [{ fruitId: 'strawberry', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    themeName: '今日主题：芒果绿茶',
    drinkName: '芒果绿茶',
    targets: [{ fruitId: 'mango', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '荔枝玫瑰茶',
    targets: [{ fruitId: 'lychee', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '菠萝椰子茶',
    targets: [
      { fruitId: 'pineapple', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'young_coconut', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '橙子苹果茶',
    targets: [
      { fruitId: 'orange', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'apple', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '柠檬蜂蜜红茶',
    targets: [{ fruitId: 'lemon', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '蓝莓桑葚茶',
    targets: [
      { fruitId: 'blueberry', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'mulberry', requiredCount: 9, cardCopies: 11 },
    ],
  ...
  },
  {
    ...
    drinkName: '西瓜青提冰茶',
    targets: [
      { fruitId: 'watermelon', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'grape_green', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '蓝莓气泡茶',
    targets: [{ fruitId: 'blueberry', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '芒果香蕉冰饮',
    targets: [
      { fruitId: 'mango', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'banana', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '桃子荔枝青柠茶',
    targets: [
      { fruitId: 'peach', requiredCount: 6, cardCopies: 8 },
      { fruitId: 'lychee', requiredCount: 6, cardCopies: 8 },
      { fruitId: 'lime', requiredCount: 3, cardCopies: 5 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 18,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '金桔柠檬茶',
    targets: [
      { fruitId: 'kumquat', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'lemon', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '苹果生姜茶',
    targets: [{ fruitId: 'apple', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '雪梨百合茶',
    targets: [
      { fruitId: 'pear', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'lily_bulb', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '橙子薄荷茶',
    targets: [
      { fruitId: 'orange', requiredCount: 12, cardCopies: 14 },
      { fruitId: 'mint', requiredCount: 3, cardCopies: 5 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '芭乐牛油果奶昔',
    targets: [
      { fruitId: 'guava', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'avocado', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '黄瓜雪梨汁',
    targets: [
      { fruitId: 'cucumber', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'pear', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '荔枝火龙果饮',
    targets: [
      { fruitId: 'lychee', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'dragonfruit', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '梅渍小番茄',
    targets: [{ fruitId: 'cherry_tomato', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    themeName: '今日主题：石榴冰茶',
    drinkName: '石榴冰茶',
    targets: [{ fruitId: 'pomegranate', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '杨梅荔枝饮',
    targets: [
      { fruitId: 'bayberry', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'lychee', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '杨梅瑞纳冰',
    targets: [{ fruitId: 'bayberry', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    drinkName: '蜜瓜燕麦拿铁',
    targets: [{ fruitId: 'cantaloupe', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    targets: [
      { fruitId: 'guava', requiredCount: 9, cardCopies: 11 },
      { fruitId: 'emblic', requiredCount: 6, cardCopies: 8 },
    ],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS + 12,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
  ...
  },
  {
    ...
    themeName: '今日主题：木瓜牛奶',
    drinkName: '木瓜牛奶',
    targets: [{ fruitId: 'papaya', requiredCount: 15, cardCopies: 17 }],
    totalStackCards: DAILY_LIMITED_MIN_STACK_CARDS,
    fruitIds: DAILY_LIMITED_COMMON_FRUITS,
...
function assertDailyLimitedLevelsValid(levels: readonly DailyThemeLevelDef[]): void {
  ...
  for (const level of levels) {
    ...
    for (const target of level.targets) {
      ...
      if (target.cardCopies < target.requiredCount || target.cardCopies > target.requiredCount + 2) {
        throw new Error(
          `[dailyLimited] ${level.themeId} ${target.fruitId} cardCopies must be between requiredCount and requiredCount + 2`,
        );
      }
