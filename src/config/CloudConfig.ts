...
export const LEVEL_MILESTONE_GIFT_STATE_KEY = `${GAME_KEY}_level_milestone_gift_v1`;
export const MILK_TEA_SHOP_PROGRESS_KEY = `${GAME_KEY}_milk_tea_shop_progress_v1`;
...
export const CLOUD_SYNC_ALLOWLIST = [
  ...
  LEVEL_MILESTONE_GIFT_STATE_KEY,
  MILK_TEA_SHOP_PROGRESS_KEY,
] as const;
